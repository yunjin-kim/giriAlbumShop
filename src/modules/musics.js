...
export default function albums(state = initialState, action) {
  switch(action.type) {
    ...
    case GET_ALBUMS_ARTISTNAME_ERROR:
      const AlbumsArtistNameHandler = handleAlbumsAsyncActions(GET_ALBUMS_ARTISTNAME, 'albums');
    ...
    case GET_ALBUMS_ALBUMNAME_ERROR:
      const AlbumsAlbumsNameHandler = handleAlbumsAsyncActions(GET_ALBUMS_ALBUMNAME, 'musics');
